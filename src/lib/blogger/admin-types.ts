...
} from "@/lib/blog-operation-profiles/operation-profile-summary";
...
export type BloggerPublishExecutionAttemptStatus = "planned_only" | "blocked_by_preflight" | "success";
...
export interface PostPublishReconciliationResponse {
  contentItemId: string;
  checkedAt: string;
  postPublishReconciliationSummary: {
    checked: true;
    mode: "preview" | "apply";
    readbackAttempted: boolean;
    readbackOk: boolean;
    ...
    publishedAt: string | null;
    updatedAt: string | null;
    matches: PublishResultReadbackResponse["publishResultReadbackSummary"]["matches"];
    externalBloggerState: PublishResultReadbackResponse["publishResultReadbackSummary"]["externalBloggerState"];
    internalDbStateBefore: PublishResultReadbackResponse["publishResultReadbackSummary"]["internalDbState"];
    proposedContentItemPatch: {
      status: "published";
      publishedAt: string | null;
      scheduledAt: null;
    ...
    proposedAttemptPatch: {
      status: "success";
      bloggerResponseRedactedJson: Record<string, unknown>;
      errorType: null;
      errorCode: null;
      errorMessageRedacted: null;
    } | null;
    appliedContentItemPatch: boolean;
    appliedAttemptPatch: boolean;
    internalDbStateAfter: PublishResultReadbackResponse["publishResultReadbackSummary"]["internalDbState"] | null;
    blockingReasons: string[];
    warnings: string[];
    sideEffectSummary: {
      dbRead: true;
...
export interface PublishOAuthGateResponse {
  ...
  finalPublishExecutionPreflightSummary: {
    ...
    selectedBlogExists: boolean;
    selectedBlogMatchesApprovalTarget: boolean | null;
    targetBlogSnapshotMatchesCurrentSelection: boolean | null;
    publishApprovalExists: boolean;
    publishApprovalStillValid: boolean;
    publishApprovalInvalidated: boolean;
    publishApprovalId: string | null;
    ...
    contentAlreadyScheduled: boolean;
    draftMarkdownHashMatchesApprovalSnapshot: boolean | null;
    draftHtmlHashMatchesApprovalSnapshot: boolean | null;
    contentSnapshotMatchesApproval: boolean;
  ...
  guardedPublishExecutionDesignSummary: {
    ...
    targetBloggerBlogName: string | null;
    targetBloggerBlogUrl: string | null;
    existingBloggerPostId: string | null;
    plannedOperationKind: "publish_existing_blogger_draft" | "publish_existing_blogger_post" | "unknown_until_publish_implementation";
    plannedBloggerApiAction: "blogger.posts.publish" | "to_be_decided_in_9E_9B";
    ...
    finalHumanApprovalRequired: true;
    redactedBloggerRequestPlan: {
      method: "POST" | "PATCH" | "PUT" | "UNKNOWN";
      endpointKind: "blogger.posts.publish" | "blogger.posts.update" | "to_be_decided";
      bloggerBlogId: string | null;
      bloggerPostId: string | null;
      usesAccessToken: true;
      accessTokenIncluded: false;
