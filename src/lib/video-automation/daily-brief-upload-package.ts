...
export async function readDailyBriefVideoPackage(run: DailyBriefRun): Promise<DailyBriefVideoPackageReadbackResult> {
  ...
  const artifacts = await Promise.all([
    ...
    artifact("voiceover_script_txt", outputDirectory, "voiceover-script.txt"),
    artifact("voiceover_audio_aiff", outputDirectory, "voiceover.aiff"),
    artifact("voiceover_audio_wav", outputDirectory, "voiceover.wav"),
    artifact("voiceover_tts_command_json", outputDirectory, "voiceover-tts-command.json"),
    artifact("voiceover_mux_command_json", outputDirectory, "voiceover-mux-command.json"),
    artifact("voiceover_render_report_json", outputDirectory, "voiceover-render-report.json"),
    artifact("video_with_voiceover_mp4", outputDirectory, "video-with-voiceover.mp4"),
