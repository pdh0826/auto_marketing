...
- Patch 9E-1에서 Blogger draft approval guard와 snapshot hash 저장이 추가됨
- Blogger draft save, publish는 아직 구현하지 않음

Patch 9E-2 목표:
- Patch 9E-1 approval snapshot match를 actual Blogger draft save의 필수 guard로 사용할지 설계한다.
...
첫 작업으로 Patch 9E-2 작업계획을 제안해줘. 아직 구현하지 말고 계획만 작성해줘.
```
