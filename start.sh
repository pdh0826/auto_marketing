...
if [[ "${USE_TMUX:-0}" == "1" ]] && command -v tmux >/dev/null 2>&1; then
  ...
  TMUX_COMMAND="cd $ROOT_Q && exec env HOST=$HOST_Q PORT=$PORT_Q DATABASE_URL=$DATABASE_URL_Q BLOGGER_PUBLIC_ASSET_BASE_URL=$BLOGGER_PUBLIC_ASSET_BASE_URL_Q BLOGGER_IMAGE_EMBED_MODE=$BLOGGER_IMAGE_EMBED_MODE_Q BLOG_PUBLIC_BASE_URL=$BLOG_PUBLIC_BASE_URL_Q NEXT_PUBLIC_APP_URL=$NEXT_PUBLIC_APP_URL_Q BLOGGER_OAUTH_REDIRECT_ORIGIN=$BLOGGER_OAUTH_REDIRECT_ORIGIN_Q BLOG_DAILY_BRIEF_AUTO_PUBLISH_LIVE_ENABLED=$BLOG_DAILY_BRIEF_AUTO_PUBLISH_LIVE_ENABLED_Q BLOG_DAILY_BRIEF_AUTO_PUBLISH_CONFIRMATION=$BLOG_DAILY_BRIEF_AUTO_PUBLISH_CONFIRMATION_Q BLOGGER_GUARDED_PUBLISH_LIVE_ENABLED=$BLOGGER_GUARDED_PUBLISH_LIVE_ENABLED_Q BLOG_DAILY_BRIEF_AUTO_PUBLISH_METHOD=$BLOG_DAILY_BRIEF_AUTO_PUBLISH_METHOD_Q BLOG_DAILY_BRIEF_BLOGGER_UI_AUTO_PUBLISH_ENABLED=$BLOG_DAILY_BRIEF_BLOGGER_UI_AUTO_PUBLISH_ENABLED_Q BLOG_DAILY_BRIEF_BLOGGER_UI_CONFIRMATION=$BLOG_DAILY_BRIEF_BLOGGER_UI_CONFIRMATION_Q BLOG_DAILY_BRIEF_BLOGGER_UI_HEADLESS=$BLOG_DAILY_BRIEF_BLOGGER_UI_HEADLESS_Q BLOG_DAILY_BRIEF_BLOGGER_UI_EDITOR_URL=$BLOG_DAILY_BRIEF_BLOGGER_UI_EDITOR_URL_Q npm run dev -- -H $HOST_Q -p $PORT_Q >>$LOG_FILE_Q 2>&1"
